...
class WorkerBridge(worker_interface.WorkerBridge):
    ...
    def __init__(self, node, my_pubkey_hash, donation_percentage, merged_urls, worker_fee):
        ...
        self.local_rate_monitor = math.RateMonitor(20*60)
        self.local_addr_rate_monitor = math.RateMonitor(20*60)
    ...
    def get_user_details(self, username):
        ...
        desired_pseudoshare_target = 240
        desired_share_target = 240
